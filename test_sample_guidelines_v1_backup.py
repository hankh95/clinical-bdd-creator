...
class GuidelineTester:
    ...
    def parse_guidelines_from_pdf_text_comprehensive(self, pdf_text: str, pdf_name: str, pdf_path: str) -> List[Dict[str, Any]]:
        ...
        for i, directive_info in enumerate(unique_directives):
            ...
            # Define multiple clinical contexts for comprehensive testing
            clinical_contexts = [
                # Standard adult patient
                {
                    "patient": {
                        "demographics": {"age": "adult", "gender": "not specified"},
                        "presentation": {"chief_complaint": "Diabetes management"},
                        "history": {"diabetes_duration": "established"}
                    },
                    "diagnosis": {"primary": "Type 2 Diabetes Mellitus", "status": "requires treatment"},
                    "labs": {"hba1c": {"value": "8.0", "unit": "%", "target": "< 7%"}},
                    "medications": {"current": "none"},
                    "comorbidities": []
                },
                ...
                {
                    "patient": {
                        "demographics": {"age": "elderly", "gender": "female"},
                        "presentation": {"chief_complaint": "Diabetes management"},
                        "history": {"diabetes_duration": "long-standing"}
                    },
                    "diagnosis": {"primary": "Type 2 Diabetes Mellitus", "status": "requires treatment"},
                    "labs": {"hba1c": {"value": "9.5", "unit": "%", "target": "< 7%"}},
                    "medications": {"current": "metformin"},
                    "comorbidities": ["hypertension", "coronary artery disease"]
                },
                # Young patient with recent diagnosis
                {
                    "patient": {
                        "demographics": {"age": "young adult", "gender": "male"},
                        "presentation": {"chief_complaint": "New diabetes diagnosis"},
                        "history": {"diabetes_duration": "recent"}
                    },
                    "diagnosis": {"primary": "Type 2 Diabetes Mellitus", "status": "new diagnosis"},
                    "labs": {"hba1c": {"value": "7.8", "unit": "%", "target": "< 7%"}},
                    "medications": {"current": "none"},
                ...
                # Patient with renal impairment
                {
                    "patient": {
                        "demographics": {"age": "adult", "gender": "not specified"},
                        "presentation": {"chief_complaint": "Diabetes with complications"},
                        "history": {"diabetes_duration": "established"}
                    },
                    "diagnosis": {"primary": "Type 2 Diabetes Mellitus", "status": "requires treatment"},
                    "labs": {"hba1c": {"value": "8.5", "unit": "%", "target": "< 7%", "egfr": {"value": "45", "unit": "mL/min/1.73m²"}}},
                    "medications": {"current": "metformin"},
                ...
                # Pregnant patient
                {
                    "patient": {
                        ...
                        "presentation": {"chief_complaint": "Gestational diabetes"},
                        "history": {"diabetes_duration": "pregnancy-related"}
                    },
                    "diagnosis": {"primary": "Gestational Diabetes", "status": "requires treatment"},
                    "labs": {"hba1c": {"value": "6.2", "unit": "%", "target": "< 6%"}},
                    "medications": {"current": "insulin"},
                    "comorbidities": ["pregnancy"]
                },
                # Patient with cardiovascular disease
                {
                    "patient": {
                        "demographics": {"age": "adult", "gender": "male"},
                        "presentation": {"chief_complaint": "Diabetes with CVD"},
                        "history": {"diabetes_duration": "established"}
                    },
                    "diagnosis": {"primary": "Type 2 Diabetes Mellitus", "status": "requires treatment"},
                    "labs": {"hba1c": {"value": "8.2", "unit": "%", "target": "< 7%"}},
                    "medications": {"current": "statin"},
                    "comorbidities": ["atherosclerotic cardiovascular disease", "dyslipidemia"]
                },
                # Patient with severe hyperglycemia
                {
                    "patient": {
                        "demographics": {"age": "adult", "gender": "not specified"},
                        "presentation": {"chief_complaint": "Severe hyperglycemia"},
                        "history": {"diabetes_duration": "established"}
                    },
                    "diagnosis": {"primary": "Type 2 Diabetes Mellitus", "status": "requires urgent treatment"},
                    "labs": {"hba1c": {"value": "12.0", "unit": "%", "target": "< 7%", "glucose": {"value": "350", "unit": "mg/dL"}}},
                    "medications": {"current": "none"},
                    "comorbidities": ["diabetic ketoacidosis risk"]
                },
                # Pediatric patient
                {
                    "patient": {
                        "demographics": {"age": "pediatric", "gender": "not specified"},
                        "presentation": {"chief_complaint": "Type 2 diabetes in youth"},
                        "history": {"diabetes_duration": "recent"}
                    },
                    "diagnosis": {"primary": "Type 2 Diabetes Mellitus", "status": "requires treatment"},
                    "labs": {"hba1c": {"value": "8.5", "unit": "%", "target": "< 7%"}},
                    "medications": {"current": "metformin"},
                    "comorbidities": ["obesity", "acanthosis nigricans"]
                }
            ]
