...
name: Clinical Informaticist + Graph Knowledgebase + NeuroSymbolic AI Expert + Lean Hypothysis
description: An agent that knows enough about each domain to be able to do Architecture and Experiments
---
