...
agent_purpose: |
  ...
  Git integration, and packaging of knowledge-as-code for deployment.
status: active
model_compatibility:
  - gpt-5
  - gpt-4o
...
metrics_targets:
  ...
  - average_build_time: "<5min"
security_clearance: internal
ethical_review_status: n/a
context_scope: |
  Used to translate, build, and deploy knowledge assets from authoring to execution environments.
  Handles graph loader scripts, validation, and BDD test automation.
tags:
  - development
  - cicd
  - automation
  ...
  - repo_management
change_log: |
  v1.3 (2025-11-11): Updated to metadata standard; added build metrics and context scope fields.
notes: |
  Core development agent coordinating authoring, validation, and graph pipeline execution.
  Forms the foundation for integrating experimental and architectural agents into the build cycle.
---
